...
//   part      they step aside to either edge, and the door to the full menu stands between them (on a phone they step
//             down to the foot of the screen, side by side, and the door stands above them)
// Words come and go by --m (the section's scroll progress, scene/scroll.ts), each step fading in and out on its own.
// The same stage on phones, with the live cups (2026-09-23); the photograph only where there is no 3D at all.
...
export default function Menu() {
  return (
    <section id="menu" className={`menu-sec latte relative z-[6] ${PHONE ? 'h-[280svh]' : 'h-[320svh]'}`}>
      <div className="sticky top-0 h-lvh overflow-hidden">
        ...
        <div className="menu-step high" style={step(-0.3, 0.3)}>
          <h2 className="display text-[11vw] md:text-[5.4vw]">Coffee. Tea. Matcha.</h2>
        </div>
